<template>
  <div class="pt-[72px] flex-grow">
    <section class="px-5 md:px-0 py-12 mb-12">
      ...
      <div class="mx-auto max-w-6xl">
        <h2 class="text-2xl md:text-2xl font-bold mb-8  max-w-2xl mx-auto  text-white">Contact PG Slot พัฒนา แก้ไข ช่วยเหลือ 24</h2>
        ...
        <p class="text-white/90 text-lg max-w-2xl mx-auto md:text-xl mb-8 leading-relaxed">
          ลืมรหัสผ่าน
          สมัครยังไง
          ทำรายการถอนแล้วแต่เครดิตยังไม่เข้า
          วิธีเล่นและเงื่อนไขเกมสล็อตมีอะไรบ้าง
        </p>
        <p class="text-white/90 text-lg max-w-2xl mx-auto md:text-xl mb-8 leading-relaxed">
          บริการประทับใจติดต่อเรา 24 ชม.
        </p>
        <p class="text-white/90 text-lg max-w-2xl mx-auto md:text-xl mb-8 leading-relaxed">
